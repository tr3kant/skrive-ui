module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        browserify: {
            ...
            dist: {
                files: {
                    'assets/js/skrive-ui.js': 'assets/js/components/main.js',
                    'assets/js/skrive-ui-public.js': 'assets/js/components/public.js'
        ...
        uglify: {
            dist: {
                files: {
                    'assets/js/skrive-ui.js': 'assets/js/components/main.js',
                    'assets/js/skrive-ui-public.min.js': 'assets/js/components/public.js'
                },
                options: { banner: compactBannerTemplate }
            }
        },
        cssmin: { dist: { files: { 'assets/css/skrive-ui.min.css': 'assets/css/skrive-ui.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/skrive-ui.min.css'] }
            }
        }
    });
